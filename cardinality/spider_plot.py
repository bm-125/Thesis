...
model_files = [
    ('Qwen2-7b-Instruct', 'output_qwen2_cardi.txt'),
    ('Qwen3-32b', 'output_qwen3_cardinality.txt'),
    ('DeepSeek-R1', 'output_deepseekc.txt'),
    ('Gemini 2.5 Flash', 'output_gemini2_5_flash.txt')
]
...
plt.title("Cardinality Constrained Contradiction Dataset Metrics", size=14)
plt.tight_layout()
plt.show()
